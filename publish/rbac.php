 ...
 * DbManager
 * return [
 *      'driver'       => \Lengbin\Hyperf\YiiDb\Rbac\Manager\DbManager::class,
 ...
 * PhpManager
 * return [
 *      'driver'       => \Lengbin\Hyperf\YiiDb\Rbac\Manager\PhpManager::class,
 *      'cache'        => \Hyperf\Cache\Cache::class, //缓存类,可以不需要
 *      'log'          => null // log key 名称
 *      'defaultRoles' => [], // 默认角色,可以不需要
 ...
 * PhpManagerFile
 * return [
 *      'driver'       => \Lengbin\Hyperf\YiiDb\Rbac\Manager\PhpManagerFile::class,
